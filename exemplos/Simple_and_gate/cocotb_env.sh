...
clear
echo ">>> Ambiente virtual Cocotb + PyUVM + cvc64 criado com sucesso!"
echo ">>> Para ativar use: source cocotb_env/bin/activate"
echo ">>> Em sua pasta de projeto foi criado o Makefile.cvc_cocotb"
exit 0